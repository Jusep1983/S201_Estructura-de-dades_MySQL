...
--
-- Host: localhost    Database: s201_lvl1ex2_youtube
-- ------------------------------------------------------
...
CREATE TABLE `video` (
  ...
  `size_in:mb` float(12,2) NOT NULL,
...
CREATE TABLE `video_tag` (
  ...
  `create_on---` varchar(45) NOT NULL DEFAULT 'DEFAULT CURRENT_TIMESTAMP',
  `video_tagcol` varchar(45) DEFAULT NULL,
  `create_video` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2025-04-08 23:59:37
